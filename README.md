...
- Сжатие истории диалога: чекбокс во фронтенд сохраняет 2 последних сообщения как есть, а остальные сообщения заменяет на summary, сгенерированное LLM. Снять чекбокс можно только после очистки истории.
